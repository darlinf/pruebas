...
import { BaseDialogRolesComponent } from './base-dialog-roles/base-dialog-roles.component';
import { BaseDialogComponent } from 'src/app/global-shared/components/base-dialog/base-dialog.component';
import { AppComponent } from 'src/app/app.component';
import { BaseDialogDeleteRoleComponent } from './base-dialog-delete-role/base-dialog-delete-role.component';
...
export class RolesComponent implements OnInit {
  ...
  removeRole(id) {
    const Dialog = this.dialog.open(BaseDialogDeleteRoleComponent, {
      data: {
        id: id,
        ...this.dialogOption.deleteConfirm('asignación'),
        minWidth: 358,
      },
    });
    Dialog.afterClosed().subscribe((r) => {
      if (r !== 'cancel') this.getRoles();
    });
  }

  assignNewRoles() {
    const Dialog = this.dialog.open(BaseDialogRolesComponent, {
    ...
    Dialog.afterClosed().subscribe((result) => {
      if (result !== 'cancel') this.getRoles();
    });
  }
}
