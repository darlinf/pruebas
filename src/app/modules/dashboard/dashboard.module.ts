...
import { BaseDialogRolesComponent } from './roles/base-dialog-roles/base-dialog-roles.component';
import { BaseDialogUsersComponent } from './users/base-dialog-user-rule/base-dialog-users.component';
import { BaseDialogDeleteUserRuleComponent } from './users/base-dialog-delete-user-rule/base-dialog-delete-user.component';
import { BaseDialogDeleteRoleComponent } from './roles/base-dialog-delete-role/base-dialog-delete-role.component';

@NgModule({
  declarations: [
    BaseDialogDeleteRoleComponent,
    BaseDialogDeleteUserRuleComponent,
    BaseDialogUsersComponent,
    BaseDialogRolesComponent,
    DashboardComponent,
