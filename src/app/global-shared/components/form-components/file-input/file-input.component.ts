...
import { BaseDialogModel } from '../../base-dialog/models/base-dialog-model';
import { BaseDialogComponent } from '../../base-dialog/base-dialog.component';
import { GlobalSharedServicesService } from '../../../global-services/global-shared-services.service';
...
export class FileInputComponent implements OnInit {
  ...
  propertyName: any;
  eventProperty: any;
  numberEventSizeAccessProperty: any;
  
  fileSizeMessage: BaseDialogModel = {
		logo: 'warning',
		title: 'Advertencia',
  ...
  constructor(
    public globalService: GlobalSharedServicesService,
    private dialog: MatDialog,
  ) { }

  runOnFileChange(event: any): void {
  ...
  ngDoCheck() {
    ...
    if (this.numberEventSizeAccessProperty == 0) {
     ...
     customValidator(control: any): { [key: string]: any } {
